...
e a realize com os valoresnuméricos na ordem que foram inseridos. Por exemplo: calculadora 
(2, ‘+’, 3). A função efetuará a soma de 2 e 3. Dica: Os sinais das operações são: ‘+’. ‘-’,
‘*’ e ‘/’. Crie um caso default para operações inválidas.
*/

function calculadoraSimples(operando1, sinal, operando2) {
    switch (sinal) {
        case '+':
...
// execução
console.log(calculadoraSimples(10, '+', 20));
console.log(calculadoraSimples(10, '-', 20));
console.log(calculadoraSimples(10, '*', 20));
console.log(calculadoraSimples(10, '/', 20));